...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        versionLabel->setText(QStringLiteral("1.3.0.0"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About IncaKoin", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>InkaCoin</b> version", Q_NULLPTR));
        copyrightLabel->setText(QApplication::translate("AboutDialog", "Copyright \302\251 2013 The BM Group\n"
"         http://www.IncaKoin.info", Q_NULLPTR));
