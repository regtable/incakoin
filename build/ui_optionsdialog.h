...
public:
    ...
    IncaKoinAmountField *transactionFee;
    QSpacerItem *horizontalSpacer_Main;
    QCheckBox *IncaKoinAtStartup;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        transactionFee = new IncaKoinAmountField(tabMain);
        ...
        IncaKoinAtStartup = new QCheckBox(tabMain);
        IncaKoinAtStartup->setObjectName(QStringLiteral("IncaKoinAtStartup"));

        verticalLayout_Main->addWidget(IncaKoinAtStartup);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        transactionFeeInfoLabel->setText(QApplication::translate("OptionsDialog", "Optional transaction fee per kB that helps make sure your transactions are processed quickly. Most transactions are 1 kB. Fee 0.0001 recommended.", Q_NULLPTR));
        transactionFeeLabel->setText(QApplication::translate("OptionsDialog", "Pay transaction &fee", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        IncaKoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start IncaKoin after logging in to the system.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        IncaKoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start IncaKoin on system login", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the IncaKoin client port on the router. This only works when your router supports UPnP and it is enabled.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the IncaKoin network through a SOCKS proxy (e.g. when connecting through Tor).", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting IncaKoin.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        displayAddresses->setToolTip(QApplication::translate("OptionsDialog", "Whether to show IncaKoin addresses in the transaction list or not.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
