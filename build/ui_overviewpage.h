...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelBalance->setText(QStringLiteral("0 NKA"));
        ...
        labelStake->setText(QStringLiteral("0 NKA"));
        ...
        labelUnconfirmed->setText(QStringLiteral("0 NKA"));
        ...
        labelImmature->setText(QStringLiteral("0 NKA"));
        ...
        verticalLayout_2->addWidget(label_wallet_bgcoin, 0, Qt::AlignHCenter|Qt::AlignVCenter);
        ...
        frame_2->setMinimumSize(QSize(365, 0));
        ...
        label_IncaKoin_Intro = new QLabel(OverviewPage);
        label_IncaKoin_Intro->setObjectName(QStringLiteral("label_IncaKoin_Intro"));

        verticalLayout_3->addWidget(label_IncaKoin_Intro);
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the IncaKoin network after a connection is established, but this process has not completed yet.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        labelNumTransactions->setToolTip(QApplication::translate("OverviewPage", "Total number of transactions in wallet", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_wallet_bgcoin->setText(QString());
        label_4->setText(QApplication::translate("OverviewPage", "<b>Recent Transactions</b>", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the IncaKoin network after a connection is established, but this process has not completed yet.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_IncaKoin_Intro->setText(QString());
    } // retranslateUi
