...
public:
    ...
    QLabel *label_15;
    QLabel *label_16;
    QLabel *label_bdb_version;
    QLabel *label_17;
    QLabel *label_boost_version;
    QLabel *label_18;
    QLabel *label_miniupnp_version;
    QLabel *label_19;
    QLabel *lable_openssl_version;
    QLabel *label_20;
    QLabel *lable_qrencode_version;
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        label_16->setGeometry(QRect(10, 30, 45, 13));
        label_bdb_version = new QLabel(tab);
        label_bdb_version->setObjectName(QStringLiteral("label_bdb_version"));
        label_bdb_version->setGeometry(QRect(100, 10, 581, 16));
        label_17 = new QLabel(tab);
        label_17->setObjectName(QStringLiteral("label_17"));
        label_17->setGeometry(QRect(10, 30, 81, 16));
        label_17->setFont(font1);
        label_boost_version = new QLabel(tab);
        label_boost_version->setObjectName(QStringLiteral("label_boost_version"));
        label_boost_version->setGeometry(QRect(100, 30, 581, 16));
        label_18 = new QLabel(tab);
        label_18->setObjectName(QStringLiteral("label_18"));
        label_18->setGeometry(QRect(10, 50, 81, 16));
        label_18->setFont(font1);
        label_miniupnp_version = new QLabel(tab);
        label_miniupnp_version->setObjectName(QStringLiteral("label_miniupnp_version"));
        label_miniupnp_version->setGeometry(QRect(100, 50, 581, 16));
        label_19 = new QLabel(tab);
        label_19->setObjectName(QStringLiteral("label_19"));
        label_19->setGeometry(QRect(10, 70, 81, 16));
        label_19->setFont(font1);
        lable_openssl_version = new QLabel(tab);
        lable_openssl_version->setObjectName(QStringLiteral("lable_openssl_version"));
        lable_openssl_version->setGeometry(QRect(100, 70, 581, 16));
        label_20 = new QLabel(tab);
        label_20->setObjectName(QStringLiteral("label_20"));
        label_20->setGeometry(QRect(10, 90, 81, 16));
        label_20->setFont(font1);
        lable_qrencode_version = new QLabel(tab);
        lable_qrencode_version->setObjectName(QStringLiteral("lable_qrencode_version"));
        lable_qrencode_version->setGeometry(QRect(100, 90, 581, 16));
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "IncaKoin - Debug window", Q_NULLPTR));
        label_9->setText(QApplication::translate("RPCConsole", "IncaKoin Core", Q_NULLPTR));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the IncaKoin debug log file from the current data directory. This can take a few seconds for large log files.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the IncaKoin-Qt help message to get a list with possible IncaKoin command-line options.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        label_15->setText(QApplication::translate("RPCConsole", "Berkeley DB:", Q_NULLPTR));
        label_16->setText(QString());
        label_bdb_version->setText(QApplication::translate("RPCConsole", "N/A", Q_NULLPTR));
        label_17->setText(QApplication::translate("RPCConsole", "Boost:", Q_NULLPTR));
        label_boost_version->setText(QApplication::translate("RPCConsole", "N/A", Q_NULLPTR));
        label_18->setText(QApplication::translate("RPCConsole", "miniupnp:", Q_NULLPTR));
        label_miniupnp_version->setText(QApplication::translate("RPCConsole", "N/A", Q_NULLPTR));
        label_19->setText(QApplication::translate("RPCConsole", "OpenSSL:", Q_NULLPTR));
        lable_openssl_version->setText(QApplication::translate("RPCConsole", "N/A", Q_NULLPTR));
        label_20->setText(QApplication::translate("RPCConsole", "qrendcode:", Q_NULLPTR));
        lable_qrencode_version->setText(QApplication::translate("RPCConsole", "N/A", Q_NULLPTR));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("RPCConsole", "Library Info", Q_NULLPTR));
    } // retranslateUi
