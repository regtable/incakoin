...
public:
    ...
    void setupUi(QFrame *SendCoinsEntry)
    {
        ...
        payAmount = new IncaKoinAmountField(SendCoinsEntry);
...
#ifndef QT_NO_TOOLTIP
        payTo->setToolTip(QApplication::translate("SendCoinsEntry", "The address to send the payment to  (e.g. NMPP3KWNxXiS3BjiYoNqvm33BkR1up9szu)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        payTo->setText(QString());
#ifndef QT_NO_TOOLTIP
